...
class SubtreeVocabExtractor:
    ...
    def __init__(self, subtree_vocab_model_path: Path):
        ...
        self.temp_subtrees_file = Path("temp_subtrees.csv")
        if self.temp_subtrees_file.exists():
            self.temp_subtrees_file.unlink()
    ...
    def create_vocab_from_dir(self, input_data_path: str):
        ...
        self.subtree_vocab.create_vocabulary(tokens=all_subtrees_vocab,
                                             model_filename=self.subtree_vocab_model_path,
                                             model_type="word")
